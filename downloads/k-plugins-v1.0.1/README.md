# k-plugins-v1.0.1.zip - Download Failed
...
| Property | Value |
|----------|-------|
| **File** | `k-plugins-v1.0.1.zip` |
| **URL** | https://github.com/ddku6dskk-hub/clipper_plugin/releases/download/v1.0.1/k-plugins-v1.0.1.zip |
| **Date** | 2026-05-11 17:49:15 UTC |
| **Status** | **FAILED** |
